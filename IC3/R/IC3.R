...
#' @param selfinter  Consider self communication or not, default is FALSE.
...
IC3 <- function(A, cellinfo, lrinfo, alpha = 0.02, selfinter = FALSE, minitr = 10, maxitr = 100, minbeta = 0) {
  library(progress)
  library(stringr)
  A <- as.matrix(A)
